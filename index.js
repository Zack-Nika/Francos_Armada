...
// ONE-TAP CHANNEL, MOVES THE USER THERE, AND SENDS A DM REMINDER
// (THIS DM AUTO-DELETES AFTER 5 SECONDS).
//
...
// A Set to keep track of members that have already received a welcome DM
...
client.on(Events.GuildMemberAdd, async member => {
  // Prevent duplicate welcome DMs by using a simple cache.
  ...
  // Remove the member ID from the welcomeSent cache after 60 seconds.
